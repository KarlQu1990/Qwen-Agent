...
class ParallelDocQA(Assistant):
    ...
    def _parse_and_chunk_files(self, messages: List[Message]):
        ...
        for file in valid_files:
            ...
            _record = self.doc_parse.call(
                params={"url": file}, parser_page_size=PARALLEL_CHUNK_SIZE, max_ref_token=PARALLEL_CHUNK_SIZE
            )
    ...
    def _ask_member_agent(
        self, index: int, messages: List[Message], lang: str = "en", knowledge: str = "", instruction: str = ""
    ) -> tuple:
